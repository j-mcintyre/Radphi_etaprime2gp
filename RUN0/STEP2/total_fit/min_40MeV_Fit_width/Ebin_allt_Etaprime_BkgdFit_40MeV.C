...
void  Ebin_allt_Etaprime_BkgdFit_40MeV() {

   // Root file with new histograms for reference in later analysis work
  	TFile *MyFile = new TFile("TwoG_may_16_2023_STEP2_40MeV.root", "NEW");
   ...
   for (int Echannel = 0; Echannel < NumEChan; Echannel++) {
      ...
      */
      ...
      TString hdirName;
      // Root file with new histograms for reference in later analysis work
      TFile *MyFile = new TFile("TwoG_may_16_2023_STEP2_40MeV.root", "UPDATE");
