...
void Etaprime_E_bin_indiv_t_fits() {
   ...
   for (int b1 = 0; b1 < tBinNum; b1++) {
      ...
      // For troubleshooting
      //std::cout << "t bin[0] = " << Etap_bins[b1][0] << std::endl;
      //std::cout << "t bin[1] = " << Etap_bins[b1][1] << std::endl;
   }
   ...
   for (int k = 0; k < NumEChan; k++) {
      ...
      //std::cout << "RangeLower = " << RangeLower[k] << std::endl;
      //std::cout << "RangeLow = " << RangeLow[k] << std::endl;
      //std::cout << "RangeDown = " << RangeDown[k] << std::endl;
      //std::cout << "RangeUp = " << RangeUp[k] << std::endl;
      //std::cout << "RangeHigh = " << RangeHigh[k] << std::endl;
      //std::cout << "RangeHigher = " << RangeHigher[k] << std::endl;
   }
   ...
   for (int Echannel = 0; Echannel < NumEChan; Echannel++) {
      ...
      for (int tchannel = 0; tchannel < tBinNum; tchannel++) {
         ...
         else if (Echannel == 1 && tchannel == 2) {
            // E1_t2; 935 MeV/c^2
            xvalue = 0.935; // GeV/c^2
            bv0 = xvalue / binw;
            binval0 = remass->GetBinContent(bv0);
            Adjustment = true;
         }
         ...
         /*
         // For troubleshooting
         std::cout << "XEtapLower = " << XEtapLower * 1000 << std::endl;
         std::cout << "XEtapLow = " << XEtapLow * 1000 << std::endl;
         std::cout << "XEtapDown = " << XEtapDown * 1000 << std::endl;
         std::cout << "XEtapUp = " << XEtapUp * 1000 << std::endl;
         std::cout << "XEtapHigh = " << XEtapHigh * 1000 << std::endl;
         std::cout << "XEtapHigher = " << XEtapHigher * 1000 << std::endl;
         std::cout << std::endl;
         */
         ...
         double g0s0 =  -sqrt(2.0 * PI) * p[18] * p[20] * TMath::Erf((p[19] - highX) / (sqrt(2.0) * p[20]))
                       + sqrt(2.0 * PI) * p[18] * p[20] * TMath::Erf((p[19] - lowX)  / (sqrt(2.0) * p[20]));

         // Partial derivitive of "iEtap_s0" wrt p[19]
         double g1s0 = pow(p[18], 2.0) * (TMath::Power(TMath::E(), (-(pow((p[19] - lowX), 2.0)  / (2.0 * pow(p[20], 2.0))))) - 
                                          TMath::Power(TMath::E(), (-(pow((p[19] - highX), 2.0) / (2.0 * pow(p[20], 2.0))))));

         // Partial derivitive of "iEtap_s0" wrt p[20]
         double g2s0 = pow(p[18], 2.0) * ((sqrt(PI / 2.0) * TMath::Erf((p[19] - lowX)  / (sqrt(2.0) * p[20]))) -
         ...
         double EtapGaus_s0 = sqrt(std::fabs(g0s0 * g0s0 * covMatrix(18, 18) + g1s0 * g1s0 * covMatrix(19, 19) + g2s0 * g2s0 * covMatrix(20, 20) +
                                             2.0 * g0s0 * g1s0 * covMatrix(18, 19) + 2.0 * g0s0 * g2s0 * covMatrix(18, 20) +
                                             2.0 * g1s0 * g2s0 * covMatrix(19, 20)));
         EtapGaus_s0 /= binw;

         std::cout << "****************************************************************************" << std::endl;
         std::cout << "****************************************************************************" << std::endl;
         std::cout << "Eta Integral = " << Sigcount_Etap << " vs. calc -> " << iEtap_s0 << std::endl;
         std::cout << "Error = " << EtapGaus_s0 << std::endl;
         std::cout << "****************************************************************************" << std::endl;
         std::cout << "****************************************************************************" << std::endl;
         ...
         */
         ...
         cout << " Check B1 Region" << endl;
         cout << "Integral = " << sb1count_Etap << endl;
         cout << "Manual = " << iEtap_b1 << endl;
         cout << "Error = " << EtapGaus_b1 << endl;
         cout << endl;
         ...
         cout << " Check B2 Region" << endl;
         cout << "Integral = " << sb2count_Etap << endl;
         cout << "Manual = " << iEtap_b2 << endl;
         cout << "Error = " << EtapGaus_b2 << endl;
         cout << endl;
         ...
         cout << " Check B0 Region" << endl;
         cout << "Integral = " << Bgcount_Etap << endl;
         cout << "Manual = " << iEtap_b0 << endl;
         cout << "Error = " << EtapGaus_b0 << endl;
         cout << endl;
         ...
         cout << " Check S1 Region" << endl;
         cout << "Integral = " << SigSb1_Etap << endl;
         cout << "Manual = " << iEtap_s1 << endl;
         cout << "Error = " << EtapGaus_s1 << endl;
         cout << endl;
         ...
         cout << " Check S2 Region" << endl;
         cout << "Integral = " << SigSb2_Etap << endl;
         cout << "Manual = " << iEtap_s2 << endl;
         cout << "Error = " << EtapGaus_s2 << endl;
         cout << endl;
         ...
         if (Calcstatus1.is_open()) {
            if (tchannel == 0) {
               Calcstatus1 << "____________________________________" << endl; 
               Calcstatus1 << "XEtapUp     = " << XEtapUp * 1000.0 << " MeV/c^2" << endl;
               Calcstatus1 << "XEtapDown   = " << XEtapDown * 1000.0 << " MeV/c^2" << endl;
               Calcstatus1 << "XEtapLow    = " << XEtapLow * 1000.0 << " MeV/c^2" << endl;
               Calcstatus1 << "XEtapLower  = " << XEtapLower * 1000.0 << " MeV/c^2" << endl;
               Calcstatus1 << "XEtapHigh   = " << XEtapHigh * 1000.0 << " MeV/c^2" << endl;
               Calcstatus1 << "XEtapHigher = " << XEtapHigher * 1000.0 << " MeV/c^2" << endl;
            }
            Calcstatus1 << " Check S0 Region" << endl;
            Calcstatus1 << "Integral = " << Sigcount_Etap << endl;
            Calcstatus1 << "Manual   = " << iEtap_s0 << endl;
            Calcstatus1 << "Error    = " << EtapGaus_s0 << endl << endl;

            Calcstatus1 << " Check S1 Region" << endl;
            Calcstatus1 << "Integral = " << SigSb1_Etap << endl;
            Calcstatus1 << "Manual   = " << iEtap_s1 << endl;
            Calcstatus1 << "Error    = " << EtapGaus_s1 << endl << endl;

            Calcstatus1 << " Check S2 Region" << endl;
            Calcstatus1 << "Integral = " << SigSb2_Etap << endl;
            Calcstatus1 << "Manual   = " << iEtap_s2 << endl;
            Calcstatus1 << "Error    = " << EtapGaus_s2 << endl << endl;

            Calcstatus1 << " Check B0 Region" << endl;
            Calcstatus1 << "Integral = " << Bgcount_Etap << endl;
            Calcstatus1 << "Manual   = " << iEtap_b0 << endl;
            Calcstatus1 << "Error    = " << EtapGaus_b0 << endl << endl;

            Calcstatus1 << " Check B1 Region" << endl;
            Calcstatus1 << "Integral = " << sb1count_Etap << endl;
            Calcstatus1 << "Manual   = " << iEtap_b1 << endl;
            Calcstatus1 << "Error    = " << EtapGaus_b1 << endl << endl;

            Calcstatus1 << " Check B2 Region" << endl;
            Calcstatus1 << "Integral = " << sb2count_Etap << endl;
            Calcstatus1 << "Manual   = " << iEtap_b2 << endl;
            Calcstatus1 << "Error    = " << EtapGaus_b2 << endl << endl;
            Calcstatus1 << "---- " << endl;
            Calcstatus1 << "---- " << endl;
            Calcstatus1 << endl;
         }
         else {
            Calcstatus1 << "Unable to open calculation check" << endl;
         }
         Calcstatus1.close();
         ...
         reset += 1;
            ...
            int RBB = 0;
               ...
               RBB = TC_RangeB[3];
				...
				output << "|t| = " << Etap_bins[tchannel][0] << " to " << Etap_bins[tchannel][1] << " GeV^2" << std::endl;
            output << "E bin = " << Echannel << ",  Tagger channel = " << RAA << " to " << RBB << std::endl;
				...
				output << std::endl;
				output << "Pi0 Fit's Peak           = " << GausMax1 * 1000.0 << " MeV/c^2" << std::endl;
				output << "Eta Fit's Peak           = " << GausMax2 * 1000.0 << " MeV/c^2" << std::endl;
				output << "Omega Leakage Fit's Peak = " << GausMax3 * 1000.0 << " MeV/c^2" << std::endl;
				output << "Etaprime Fit's Peak      = " << GausMax4 * 1000.0 << " MeV/c^2" << std::endl;
				output << std::endl;
      ...
      TH1D *hEtap_W0 = new TH1D(hist0Name, "#eta' Signal Region Sideband Subtraction Weight;Weight #pm Error [1^{st} Bin #pm 2^{nd} Bin];Value", 40, 0, 40);
      //hEtap_W0->Sumw2();

      // w1 weight and error
      // bin 1 = w1, bin 2 = error
      TString hist1Name = Form("h_W1_E%d", Echannel);
      TH1D *hEtap_W1 = new TH1D(hist1Name, "#eta' Lower Mass Region Sideband Subtraction Weight;Weight #pm Error [1^{st} Bin #pm 2^{nd} Bin];Value", 40, 0, 40);
      //hEtap_W1->Sumw2();

      // w2 weight and error
      // bin 1 = w2, bin 2 = error
      TString hist2Name = Form("h_W2_E%d", Echannel);
      TH1D *hEtap_W2 = new TH1D(hist2Name, "#eta' Higher Mass Region Sideband Subtraction Weight;Weight #pm Error [1^{st} Bin #pm 2^{nd} Bin];Value", 40, 0, 40);
      //hEtap_W2->Sumw2();
      ...
      for (int yurt = 0; yurt < tBinNum; yurt++) {
         ...
         hEtap_W0->SetBinContent(bbq, w_etap_sigW[yurt]);
         hEtap_W0->SetBinContent(acq, w0_errW[yurt]);

         hEtap_W1->SetBinContent(bbq, w1_etap_sbW[yurt]);
         hEtap_W1->SetBinContent(acq, w1_errW[yurt]);

         hEtap_W2->SetBinContent(bbq, w2_etap_sbW[yurt]);
         hEtap_W2->SetBinContent(acq, w2_errW[yurt]);
      }
      gFile = MyFile;
      ...
      if (FitPar2.is_open()) {
         ...
         for (int iterT = 0; iterT < tBinNum; iterT++) {
            ...
            FitPar2 << "w_etap_sig  = " << w_etap_sigW[iterT] << std::endl;
            FitPar2 << "w0_err      = " << w0_errW[iterT] << std::endl;
            FitPar2 << "w_etap_sb1  = " << w1_etap_sbW[iterT] << std::endl;
            FitPar2 << "w1_err      = " << w1_errW[iterT] << std::endl;
            FitPar2 << "w_etap_sb2  = " << w2_etap_sbW[iterT] << std::endl;
            FitPar2 << "w2_err      = " << w2_errW[iterT] << std::endl;

            FitPar2 << "R1_Etap     = " << wR1_Etap[iterT] << std::endl;
            FitPar2 << "R1_err      = " << wR1_err[iterT] << std::endl;
            FitPar2 << "R2_Etap     = " << wR2_Etap[iterT] << std::endl;
            FitPar2 << "R2_err      = " << wR2_err[iterT] << std::endl;
            FitPar2 << "C1_Etap     = " << wC1_Etap[iterT] << std::endl;
            FitPar2 << "C1_err      = " << wC1_err[iterT] << std::endl;
            FitPar2 << "C2_Etap     = " << wC2_Etap[iterT] << std::endl;
            FitPar2 << "C2_err      = " << wC2_err[iterT] << std::endl;

            FitPar2 << "iEtap_s0    = " << wiEtap_s0[iterT] << std::endl;
            FitPar2 << "EtapGaus_s0 = " << wEtapGaus_s0[iterT] << std::endl;
            FitPar2 << "iEtap_s1    = " << wiEtap_s1[iterT] << std::endl;
            FitPar2 << "EtapGaus_s1 = " << wEtapGaus_s1[iterT] << std::endl;
            FitPar2 << "iEtap_s2    = " << wiEtap_s2[iterT] << std::endl;
            FitPar2 << "EtapGaus_s2 = " << wEtapGaus_s2[iterT] << std::endl;
            FitPar2 << "iEtap_b0    = " << wiEtap_b0[iterT] << std::endl;
            FitPar2 << "EtapGaus_b0 = " << wEtapGaus_b0[iterT] << std::endl;
            FitPar2 << "iEtap_b1    = " << wiEtap_b1[iterT] << std::endl;
            FitPar2 << "EtapGaus_b1 = " << wEtapGaus_b1[iterT] << std::endl;
            FitPar2 << "iEtap_b2    = " << wiEtap_b2[iterT] << std::endl;
            FitPar2 << "EtapGaus_b2 = " << wEtapGaus_b2[iterT] << std::endl;
            FitPar2 << "-------------------" << std::endl;
            FitPar2 << std::endl;
         }
         FitPar2 << std::endl;
