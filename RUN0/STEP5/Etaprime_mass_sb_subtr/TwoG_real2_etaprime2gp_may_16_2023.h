...
////////////////////////////////////////////////////////////////////////
// This was written to look at in the 2 gamma sample on Oct. 11, 2021.//
// This file is a re-do of ER_real_etaprime2gp_oct_21_2020.C,         //
...
//                                                                    //
// The new ER equals 0.965, as determined by the various attempts in  //
...
// This file's name --> TwoG_real2_etaprime2gp_may_16_2023            //
////////////////////////////////////////////////////////////////////////


#ifndef TwoG_real2_etaprime2gp_may_16_2023_h
#define TwoG_real2_etaprime2gp_may_16_2023_h
...
class TwoG_real2_etaprime2gp_may_16_2023 : public TSelector {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

   //TTree          *fWgtFile;   //!pointer to a TFile
   ...
   TH1D *tEtap3;
   TH1D *dphi_Etap3;
   TH1D *Etap_dphi_E0_t[3];
   TH1D *Etap_dphi_E1_t[3];
   TH1D *Etap_dphi_E2_t[3];
   TH1D *Etap_dphi_E3_t[3];
   /*   */
   TH1D *hBinDW;
   TH1D *hBinUP;
   ...
   TH1D *SB_Regions_allt_E0;
   TH1D *SB_Regions_allt_E1;
   TH1D *SB_Regions_allt_E2;
   TH1D *SB_Regions_allt_E3;
   ...
   TwoG_real2_etaprime2gp_may_16_2023(TTree *tree=0);
   ...
   ClassDef(TwoG_real2_etaprime2gp_may_16_2023,0);

};

#endif

#ifdef TwoG_real2_etaprime2gp_may_16_2023_cxx
TwoG_real2_etaprime2gp_may_16_2023::TwoG_real2_etaprime2gp_may_16_2023(TTree *tree) : fChain(0) 
{
...
void TwoG_real2_etaprime2gp_may_16_2023::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Etag0", Etag0, &b_Etapg0);
   fChain->SetBranchAddress("Etag1", Etag1, &b_Etapg1);
...
Bool_t TwoG_real2_etaprime2gp_may_16_2023::Notify()
{
...
#endif // #ifdef TwoG_real2_etaprime2gp_may_16_2023_cxx
